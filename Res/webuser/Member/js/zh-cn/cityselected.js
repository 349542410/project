$(function(){               
  ...
  $("#loc_province").css({'display':'inline-block','border':'none','margin':'0','position':'absolute','left':'85px','top':'9px','z-index':'-1'});
  $("#loc_city").css({'display':'inline-block','border':'none','margin':'0','position':'absolute','left':'194px','top':'9px','z-index':'-1'});
  $("#loc_town").css({'display':'inline-block','border':'none','margin':'0','position':'absolute','left':'319px','top':'9px','z-index':'-1'});
  function fz_value(){

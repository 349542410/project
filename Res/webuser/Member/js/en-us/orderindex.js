    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(!data.success){
                ...
                $('#provinces').val('111');
                $('#citys').val(data.info.city);
                $('#towns').val(data.info.town);

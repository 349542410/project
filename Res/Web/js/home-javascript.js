$(function () {
  ...
  $("#nav2 li.service").hover(function () {
    ...
    $("#nav2 li.service p.now1 b.a").stop().animate({
      ...
      $("#nav2 li.service p.now1 b.a").animate({
        'fontSize': '20px'
      }, function () {
    ...
    $("#nav2 li.service p.now1 b").stop().animate({
      'fontSize': '20px'
    }, function () {
      $(this).css('color', '#fff');
    });
  ...
  $("#nav2 li.freight").mouseover(function () {
    if (falt == 1 || falt == 3 || falt == 4) {
      ...
      $("#nav2 li.freight_now").stop().animate({
        'left': '0'
      });
      doclick_hide();
  ...
  $("#nav2 li.query").mouseover(function () {
    if (falt == 1 || falt == 2 || falt == 4) {
      ...
      $("#nav2 li.query_now").stop().animate({
        'left': '0'
      });
      doclick_hide();
      $(this).find('p.a1').css('display', 'none');

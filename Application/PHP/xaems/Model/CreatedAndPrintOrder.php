...
class CreatedAndPrintOrder extends ExpressServiceApi
{
    /**
     *
     * @Assert\NotBlank()
    ...
    public function setInnerGoods($post)
    {
        ...
        if (!empty($post['form']['Brands'])) {
            foreach ($post['form']['Brands'] as $key => $val) {
                ...
                $arr['TariffNumber'] = $post['form']['TariffNumber'][$key];
    ...
    public function setSender($sendmsg)
    {
        if (!empty($sendmsg)) {
            $date = array(
                ...
                'FromArea' =>  $sendmsg['FromArea'],
                'FromCity' =>  $sendmsg['FromCity'],
                'FromEmail' =>  $sendmsg['FromEmail'],
                'FromMobile' =>  $sendmsg['FromMobile'],
                'FromName' =>  $sendmsg['FromName'],
                'FromProvince' =>  $sendmsg['FromProvince'],
                'FromZIP' =>  $sendmsg['FromZIP'],
            );
            $this->_Sender = $date;
        }
    }

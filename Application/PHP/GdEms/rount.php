 ...
 */
	...
	$kd7    = $out_load.'\Kdno7.class.php';
	$kdfile = $out_load.'\Kdno7.conf.php';
	require_once($kd7);//加载类
	...
	/* Jie 20160921 */
	// 线程名称
	$node = isset($_GET['node']) ? $_GET['node'] : 'Gd_ems';//默认 Gd_ems 广东邮政
...
//============= 测试   ========
		...
		$nu_list =  array('0'=>array('STNO'=>'BE972032890HK'));//新 测试用

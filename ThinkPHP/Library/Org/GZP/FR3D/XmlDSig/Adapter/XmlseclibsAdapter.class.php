...
namespace Org\GZP\FR3D\XmlDSig\Adapter;

use DOMDocument;
use DOMNode;
use Org\GZP\RobRichards\XMLSecLibs\XMLSecEnc;
use Org\GZP\RobRichards\XMLSecLibs\XMLSecurityDSig;
use Org\GZP\RobRichards\XMLSecLibs\XMLSecurityKey;

...
require_once(C('__IOS_ALIPAY__').'aop/AlipayMobilePublicMultiMediaClient.php');
...
//  测试
require_once(C('__ALIPAY__').'alipay.config.php');
// print_r($alipay_config);exit;
$test1 = new TestImage();

$test1->alipay_public_key   = $alipay_config['alipay_public_key'];
$test1->serverUrl 			= $alipay_config['notify_url'];
$test1->appId 				= $alipay_config['partner'];

$test1->partner_private_key = $alipay_config['private_key'];
$return_cs  = $test1 -> load();

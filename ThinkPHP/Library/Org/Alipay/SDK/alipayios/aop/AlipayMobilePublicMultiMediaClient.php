...
class AlipayMobilePublicMultiMediaClient{
	...
	private				$apiMethodName = "alipay.trade.app.pay";
	...
	function __construct($serverUrl = '', $appId = '', $partner_private_key = '', $format = '', $charset = 'utf-8'){
	...
	public function getContents(){
		...
		$datas = array(
			"app_id" 		=> $this -> appId,
			"method" 		=> $this -> apiMethodName,
			"sign_type" 	=> $this -> sign_type,
			"version" 		=> $this -> apiVersion,
			"notify_url=" 	=> "http://pay.megao.hk:81/Alipay/notifyurl",
			"timestamp" 	=> date('Y-m-d H:i:s')  ,//yyyy-MM-dd HH:mm:ss
			"biz_content" 	=> '{"timeout_express":"30m","seller_id":"2088421416276353","product_code":"QUICK_MSECURITY_PAY","total_amount":"1.01","subject":"1","body":"我是测试数据","out_trade_no":"2017011008993"}',

...
class WxPayApi
{
	...
	public static function notify($callback, &$msg)
	{
		...
		// 		</xml>\n";
		 ...
		 ///* 测试使用录入文档 */
        //$myfile = fopen("D:/www/upfiles/a/Advert/log_ali20190427.text", "a") or die("Unable to open file!"); 

        // $txt = "pc扫码code = " . $verify_result["code"]."\n";
        // $txt .= "error = " . $verify_result["error"]."\n";
        // $txt .= "data = " . json_encode($verify_result)."\n";
